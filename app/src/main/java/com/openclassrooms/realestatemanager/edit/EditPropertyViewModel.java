...
public class EditPropertyViewModel extends ViewModel {
    ...
    private MutableLiveData<List<Property.PointOfInterest>> pointOfInterestList = new MutableLiveData<>();
    @Inject
    ...
    public LiveData<List<Property.PointOfInterest>> getCurrentPropertyPointOfInterests(){
        return pointOfInterestList;
    }
